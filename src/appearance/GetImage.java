...
public class GetImage {
    ...
    private BufferedImage steveConditions;
    private BufferedImage blockAnimation;

    public GetImage(){
        steveConditions = loadImage("/mario-forms.png");
        blockAnimation = loadImage("/brick-animation.png");
    }
    ...
    public BufferedImage[] getLeftFrames(int marioForm){
        ...
        for(int i = 0; i < 5; i++){
            leftFrames[i] = steveConditions.getSubimage((col-1)*width, (i)*height, width, height);
        }
        return leftFrames;
    }
    ...
    public BufferedImage[] getRightFrames(int marioForm){
        ...
        for(int i = 0; i < 5; i++){
            rightFrames[i] = steveConditions.getSubimage((col-1)*width, (i)*height, width, height);
        }
        return rightFrames;
    }
